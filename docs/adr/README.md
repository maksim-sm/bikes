...
| [0029](0029-admin-shell-authorization.md)          | Admin shell, staff idle timeout, audit context  | Accepted (amended by [0030](0030-admin-inventory-operations.md), [0031](0031-admin-audit-log.md)) |
| [0030](0030-admin-inventory-operations.md)         | Staff stock view, adjustments, movement actor   | Accepted                                                                                          |
| [0031](0031-admin-audit-log.md)                    | Admin audit log; no secrets in payloads         | Accepted                                                                                          |
